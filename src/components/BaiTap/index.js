...
import { BaiTapContainer, ShowAnswer } from './BaiTapElements';
import * as BaiTap from '../DetailCoursesElements/index';
import * as GoiY from '../Parts/index'
import { useDispatch } from 'react-redux';
import { getHint } from '../../redux/actions/GoiYAction';
...
const BaiTapPage = () => {
    ...
    const handleHint = (index) => {
        if (index < 10) {
            dispatch(getHint(hint))
            setLink("/toanroirac/logic")
        } else if (index < 20) {
            setLink("/toanroirac/quanhe")
        } else {
            setLink("/toanroirac/boole")
        }
    }
        ...
        <BaiTap.Container>
            ...
            <BaiTap.RightColumn>
                ...
                <BaiTap.Div id="1_2">
                    ...
                    <BaiTap.Div hidden={show[1].value}>
                        <BaiTap.RightP>
                            <BaiTap.RightWordBold>Bài giải: </BaiTap.RightWordBold><br />
                            n = 1: 7 + 3 - 1 = 9 chia hết cho 9 <br />
                    ...
                    <ShowAnswer onClick={() => handleClick(2)}>Đáp án</ShowAnswer>
                    <ShowAnswer href={link} onClick={() => handleHint(2)} target="_blank">Gợi ý</ShowAnswer>
                    {/* <input type="button" onclick="window.open(&quot;window-child.html&quot;,&quot;Ratting&quot;,&quot;width=550," height="170,left=150,top=200,toolbar=0,status=0,&quot;);" defaultValue="Open Window" /> */}
                ...
                <BaiTap.Div id="1_4">
                    ...
                    <BaiTap.Div hidden={show[3].value}>
                        <BaiTap.RightP>
                            <BaiTap.RightWordBold>Bài giải: </BaiTap.RightWordBold><br />
                    ...
                    <ShowAnswer onClick={() => handleClick(4)}>Đáp án</ShowAnswer>
                    {/* <BaiTap.Image style={{ marginLeft: "80px" }} src={require('../../images/boole/1.png').default} /> */}
                </BaiTap.Div>
                {/* 2 */}
                <BaiTap.Div id="2">
